...
const i18n = (() => {
    ...
    const TRANSLATIONS = {
        it: {
            ...
            'connect.pm3_path': 'Percorso client Proxmark3',
            'connect.browse': 'Sfoglia…',
            'connect.com_port': 'Porta COM / tty',
            ...
            'connect.path_error': 'Specifica il percorso del client Proxmark3',
            'connect.port_error': 'Seleziona una porta seriale (es. COM3 o /dev/ttyACM0)',
            'connect.starting_pm3': 'Avvio client Proxmark3 su {port}…',
            'connect.connected_msg': 'Connesso! (PID {pid}) Apertura dashboard…',
            'connect.path_ok': '✓ Eseguibile Proxmark3 riconosciuto',
            'connect.path_warn': 'Assicurati che sia proxmark3 (o proxmark3.exe)',
        ...
        en: {
            ...
            'connect.title': 'PM3 HotMan',
            'connect.subtitle': 'Proxmark3 GUI — Iceman Fork',
            'connect.pm3_path': 'Proxmark3 Client Path',
            'connect.browse': 'Browse…',
            'connect.com_port': 'COM / tty Port',
            ...
            'connect.path_error': 'Specify the path to Proxmark3 client',
            'connect.port_error': 'Select a serial port (e.g. COM3 or /dev/ttyACM0)',
            'connect.starting_pm3': 'Starting Proxmark3 client on {port}…',
            'connect.connected_msg': 'Connected! (PID {pid}) Opening dashboard…',
            'connect.path_ok': '✓ Valid Proxmark3 executable recognized',
            'connect.path_warn': 'Ensure it is proxmark3 (or proxmark3.exe)',
